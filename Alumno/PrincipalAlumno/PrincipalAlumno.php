       ...
       <!-- <section id="banner">
        ...
        <section id="info">
            ...
            <div class="contenedor">
                <div class="info-menu">
                    <a href="../RequisicionAlumno/RequisicionAlumno/RequisicionAlumno.php"><img src="Images/requi.png" alt="Requisicion"> </a>
                    <h4>Generar Requisición</h4>
                </div>
                <div class="info-menu">
                    <a href="../ActualizarAlumno/ActualizarAlumno/ActualizarAlumno.php"><img src="Images/grupo.jpg" alt="Mis DAtos"> </a>
