...
function formValidate(formId,formMsg){
	...
	if(flag==1){
	    $(formMsg).html('<div class="text-danger"><i class="fa fa-exclamation-circle"></i> Los campos de asterisco son obligatorios! </div>');
		return false;
	}
	
	$(".overlay").show();
	$(".overlay").html('<div class="text-light"><span class="spinner-grow spinner-grow-sm" role="status"></span> Espera por Favor...!</div>');
