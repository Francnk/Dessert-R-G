...
<body>
		...
		<div class="navbar navbar-expand-lg  " style="background:#092432">
			...
			<nav class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="nav navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link text-white" href="../../cuatrimestre.php">Regresar</a>
					</li>
	...
	<br>
	<div class="container">
		<h2 class="font-weight-bold text-center">GRUPOS QUE INTREGA EL CUATRIMESTRE</h2>
		<div class="row">
			<div class="table-responsive ">
				<a href="#addnew<?php echo $id; ?>" class="btn btn text-white  " style="background:#be1e2d " data-toggle="modal"> <i class="fas fa-user"></i> Nuevo Grupo</a>
				...
				<table class="table table-striped table-hover  table-bordered " style="margin-top:20px;" id="tabladi">
					...
					<tbody>
						...
						try {
							...
							$sql = 'CALL mostrar_id_cuatrimestre_grupo (' . $id_periodo . ',' . $id_programa . ',' . $id_cuatrimestre . ')';
