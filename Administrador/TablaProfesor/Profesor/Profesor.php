...
<body>
	<header>
		...
		<div class="row1 fixed-top" style="background:#454545 ">
			<div class="col-sm-2">
				<a><img class="img1" src="../../Images/logos/utvm.png" height="55px " alt="Responsive image"></a>
			</div>
		</div>
		<div class="col-sm-10 text-center">
			<h4 class="texto  text-white text-center"> UTVM Unidad Académica de Tezontepec</h4>
		</div>


		<div class="navbar navbar-expand-lg  " style="background:#092432">
			<img src="../../Images/logos/logito.png" height="40px">
	...
	<br>
	<div class="container">
		<!--Div del contenido de la TABLA-->
		<h2 class="font-weight-bold text-center">PROFESOR</h2>
		<div class="row">
			<div class="table-responsive ">
				<a href="#addnew" class="btn btn text-white" style="background:#5daa49"  data-toggle="modal"> <i class="fas fa-user"></i> Nuevo profesor</a>
				...
				<table class="table table-striped table-hover  table-bordered " style="margin-top:20px;" id="tabladi">
					<thead class="p-3 mb-2 bg " style="background:#5daa49">
						<tr>
							<!--pag-->
							<th class="text-xl-center  text-white ">NÚMERO DE EMPLEADO</th>
							<th class="text-xl-center  text-white ">NOMBRE DEL PROFESOR</th>
					...
					<tbody>
						...
						?>
								<tr>
									...
									<td>
										<center>
											<a href="#edit_<?php echo $row['numero_empleado']; ?>" class="btn1 btn-success  btn-sm" style="background:#5daa49" data-toggle="modal"><span class="icon"><i class="fas fa-edit"></i></span>Editar</a>
											<a href="#delete_<?php echo $row['numero_empleado']; ?>" class="btn1 btn-danger btn-sm" style="background:#be1e2d" data-toggle="modal"><span class="icon"><i class="fas fa-trash"></i></span> Borrar</a>
									</td>
