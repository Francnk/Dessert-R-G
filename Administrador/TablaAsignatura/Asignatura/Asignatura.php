...
<body>
	...
	<br>
	<div class="container">
		<h2 class="font-weight-bold text-center">ASIGNATURA</h2>
		<div class="row">
			<div class="table-responsive ">
				<a href="#addnew" class="btn btn text-white  " style="background:#5daa49 " data-toggle="modal"> <i class="fas fa-user"></i> Nueva asignatura</a>
				<!--  -->
				...
				<table class="table table-striped table-hover  table-bordered " style="margin-top:20px;" id="tabladi">
					<thead class="p-3 mb-2 bg " style="background:#5daa49">
						<tr>
							<!--pag-->
							<th class="text-xl-center  text-white ">PERIODO / AÑO </th>
							<th class="text-xl-center  text-white ">PROGRAMA EDUCATIVO </th>
							<th class="text-xl-center  text-white ">CUATRIMESTRE</th>
							<th class="text-xl-center  text-white ">PROFESOR</th>
							<th class="text-xl-center  text-white ">ASIGNATURA </th>
					...
					<tbody>
						...
						$db = $database->open();
						try {
							$sql = "CALL mostrar_asignaturas2";
							foreach ($db->query($sql) as $row) {
						?>
								<tr>
									<td><?php echo $row['periodo']; ?> <?php echo $row['year']; ?></td>
									...
									<td>
										<center>
											...
											<button href="#edit_<?php echo $row['id_asignatura']; ?>" class="btn1 btn-success  btn-sm" style="background:#5daa49" data-toggle="modal"><span class="icon"><i class="fas fa-edit"></i></span>Editar</button>
											<button href="#delete_<?php echo $row['id_asignatura']; ?>" class="btn1 btn-danger btn-sm" style="background:#be1e2d" data-toggle="modal"><span class="icon"><i class="fas fa-trash"></i></span> Borrar</button>
