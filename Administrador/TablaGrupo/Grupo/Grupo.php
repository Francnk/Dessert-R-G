...
<body>
	...
	<br>
	<div class="container">
		<h2 class="font-weight-bold text-center">GRUPO</h2>
		<div class="row">
			<div class="table-responsive ">
				<a href="#addnew" class="btn btn text-white" style="background:#5daa49"  data-toggle="modal"> <i class="fas fa-user"></i> Nuevo Grupo</a>
					...
					<tbody>
						...
						?>
								<tr>
									...
									<td>
										<center>
											<a href="#edit_<?php echo $row['id_grupo']; ?>" class="btn1 btn-success  btn-sm" style="background:#5daa49" data-toggle="modal"><span class="icon"><i class="fas fa-edit"></i></span>Editar</a>
											<a href="#delete_<?php echo $row['id_grupo']; ?>" class="btn1 btn-danger btn-sm" style="background:#be1e2d" data-toggle="modal"><span class="icon"><i class="fas fa-trash"></i></span> Borrar</a>
									</td>
