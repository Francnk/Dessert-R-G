	...
	<div class="container">
		...
		<div class="row">
			<div class="table-responsive ">
				<a href="#addnew" class="btn btn text-white" style="background:#5daa49" data-toggle="modal"><i class="fas fa-user"></i> Nuevo Utensilio</a>
				...
				<table class="table table-striped table-hover  table-bordered " style="margin-top:20px;" id="tabladi">
					<thead class="p-3 mb-2 bg " style="background:#5daa49">
						<tr>
							<!--pag-->
							<th class="text-xl-center  text-white ">CATEGORIA</th>
					...
					<tbody>
						...
						?>
								<tr>
									...
									<td>
										<center>
											<a href="#edit_<?php echo $row['id_utensilio']; ?>" class="btn1 btn-success  btn-sm" style="background:#5daa49" data-toggle="modal"><span class="icon"><i class="fas fa-edit"></i></span>Editar</a>
											<a href="#delete_<?php echo $row['id_utensilio']; ?>" class="btn1 btn-danger btn-sm" style="background:#be1e2d" data-toggle="modal"><span class="icon"><i class="fas  fa-trash"></i></span> Borrar</a>
											<!--agregar s-->
									</td>
