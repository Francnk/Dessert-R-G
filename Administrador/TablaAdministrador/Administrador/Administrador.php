...
<body>
	...
	<br>
	<div class="container">
		<h2 class="font-weight-bold text-center">ADMINISTRADOR</h2>
		<div class="row">
			<div class="table-responsive ">
				<a href="#addnew" class="btn btn text-white" style="background:#5daa49"  data-toggle="modal"> <i class="fas fa-user"></i> Nuevo administrador</a>
				<em id="signUpMsg"></em>
				<?php
				/*if (!isset($_SESSION)) {
					session_start();
				...
				<table class="table table-striped table-hover  table-bordered " style="margin-top:20px;" id="tabladi">
					<thead class="p-3 mb-2 bg " style="background:#5daa49">
						<tr>
							<!--pag-->
							<th class="text-xl-center  text-white ">NÚM. EMPLEADO</th>
							<th class="text-xl-center  text-white ">NOMBRE COMPLETO</th>
							<th class="text-xl-center  text-white ">CORREO ELECTRONICO</th>
					...
					<tbody>
						...
						try {
							...
							$sql = 'call Mostrar_administrador';
						...
						?>
								<tr>
									...
									<?php include('../Administrador/BorrarEditarModal.php'); ?>
								</tr>
								</center>
						<?php
							}
	...
	<?php include('../Administrador/AgregarModal.php'); ?>
	<!--pag
